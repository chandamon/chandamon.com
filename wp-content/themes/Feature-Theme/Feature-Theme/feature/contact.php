...
<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/contact-form.js"></script>
 ...
 <div class="tcto-co"><?php $ctpgh= get_option(SHORT_NAME . 'ctpgh'); echo $ctpgh; ?></div>
 <div class="tcto-entryco"><?php $ctpdscrip= get_option(SHORT_NAME . 'ctpdscrip'); echo $ctpdscrip; ?></div>
