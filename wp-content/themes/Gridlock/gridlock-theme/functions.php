...
<div class="wrap">
	<div id="gridlock-div">
				...
				<tbody>
					<tr>
						...
						<td>
							...
							?>
							<select name="gridlock_featured_cat">
							<?php
					...
					<tr>
						...
						<td>
							...
							?>
							<select name="gridlock_secondary_cat">
							<?php gridlock_dropdown_cats(true, 'All Categories', 'ID', 'asc', false, false, true, false, $selected_cat); 
							?>
							</select>
						</td>
					</tr>
		...
		<div id="gridlockCaption">
			<p><strong>Gridlock 1.4</strong> (Build 6) &copy; 2005-2006 Eston Bond. Some rights reserved.</p>
...
// modified dropdown_cats for gridlock options use
