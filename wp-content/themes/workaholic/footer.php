...
<div class="grid_4">
	<p><a href="http://www.graphpaperpress.com">WordPress Themes</a> by Graph Paper Press</p>
</div>
<div class="clear"></div>
</div>
...
<?php if(is_home()) {
    ...
    if ( function_exists( 'get_option_tree') && get_option_tree( 't_twitter_id') <> '' ) { 
        $twitterID = get_option_tree( 't_twitter_id'); 
        } else {             
