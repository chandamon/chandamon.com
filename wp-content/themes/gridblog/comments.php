...
<small class="commentmetadata">	By <strong><?php comment_author_link() ?></strong> on <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('M j, Y') ?></a> | <a href="#respond">Reply</a><?php edit_comment_link('Edit',' | ',''); ?></small>
...
<?php
	...
	<ol class="tblist" style="list-style:none;">
...
<?php if (get_comment_type()!="comment") : ?>
	...
	<small class="commentmetadata"><?php comment_date('M j, Y') ?>:</small> <font style="font-size:11px;"><?php comment_author_link() ?></font>
		<?php if ($comment->comment_approved == '0') : ?>
		<em>Your comment is awaiting moderation.</em>
		<?php endif; ?>
	</li>
...
<input type="text" name="email" id="email" value="E-mail" onfocus="if (this.value == 'E-mail') {this.value = '';}" onblur="if (this.value == '') {this.value = 'E-mail';}" size="22" tabindex="2" />
<input type="text" name="url" id="url" value="Website" onfocus="if (this.value == 'Website') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Website';}" size="22" tabindex="3" />
<br clear="all" />

	<?php endif; ?>

		<p><textarea name="comment" id="comment" value="Comments" onfocus="if (this.value == 'Comments') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Comments';}"  cols="5" rows="10" tabindex="4"></textarea></p>
